...
from posenet_in_nerf import VERSION, VERSION_SHORT  # noqa: E402

# -- Project information -----------------------------------------------------

project = "posenet-in-nerf"
...
html_title = f"posenet-in-nerf v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/qimaqi/PoseNet_in_NeRF",
            "html": """
